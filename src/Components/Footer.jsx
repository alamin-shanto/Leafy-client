...
const Footer = () => {
  return (
    <footer className="bg-[var(--primary)] text-[var(--base-100)] py-10 px-6 rounded-t-lg shadow-inner">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-0">
        ...
        {/* Social Icons */}
        <div className="flex justify-center space-x-8 text-[var(--base-100)]">
          <a
      ...
      {/* Copyright */}
      <div className="mt-8 text-center text-sm text-[var(--secondary)] select-none">
